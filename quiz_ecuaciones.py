...
# ── Estilos (tema blanco/pastel, texto oscuro) ───────────────────────────────
st.markdown("""
<style>
...
# ── Persistencia del control del profesor ─────────────────────────────────────
def cargar_control():
...
# ════════════════════════════════════════════════════════════════════════════════
    ...
    if control["resultados_visibles"]:
        # ── El profesor activó la retroalimentación ──
        ...
        # ── Retroalimentación aún no activada ──
        st.markdown("### ✅ ¡Quiz enviado exitosamente!")
        st.markdown(
            "<div class='pending-box'>"
            "⏳ Tu calificación y retroalimentación estarán disponibles "
            "cuando el profesor las active. Vuelve más tarde a esta página para verlas."
            "</div>",
            unsafe_allow_html=True
        )
...
# ════════════════════════════════════════════════════════════════════════════════
    ...
    with col_a:
        if control["resultados_visibles"]:
            st.success("✅ Los estudiantes **pueden ver** su calificación y retroalimentación.")
        else:
            st.warning("🔒 Los estudiantes **NO pueden ver** aún su calificación.")
    with col_b:
        if control["resultados_visibles"]:
    ...
    # ── Zona de peligro: borrar registros ─────────────────────────────────────
    st.markdown("<div class='card'>", unsafe_allow_html=True)
